...
export default function OnboardingSlides() {
  ...
  const slides = [
    ...
    },
    {
      ...
      glow: 'bg-lucidar-lime/40',
      title: 'Customize Everything',
      desc: 'Build your unique identity with animated avatars, profile themes, and Nitro-style effects that make you stand out from the crowd.'
    },
    {
  ...
  return (
    <div 
      className="min-h-screen bg-lucidar-bg relative overflow-hidden flex items-center justify-center p-6"
      style={{ fontFamily: "'Chillax', sans-serif" }}
    >
      {/* Subtle animated background - consistent dark base */}
      <motion.div 
        key={`bg-${current}`}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {/* Brand-consistent floating orbs - lime/green only */}
      <motion.div 
        animate={{ x: [0, 30, 0], y: [0, -20, 0] }}
        transition={{ duration: 6, repeat: Infinity }}
        className={`absolute top-20 left-20 w-72 h-72 rounded-full ${slide.glow} opacity-20 blur-[100px]`}
      />
      <motion.div 
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-lucidar-dark/80 backdrop-blur-2xl border border-gray-800 shadow-2xl">
            {/* Inner gradient glow - subtle brand accent */}
            ...
            <div className="relative p-8 pt-12">
              ...
              <div className="relative mb-8 flex justify-center">
                <motion.div
                  ...
                  className="relative"
                >
                  {/* Glow behind image - brand consistent */}
              ...
              <div className="text-center mb-8">
                ...
                >
                  ...
                  <span className="text-xs text-lucidar-lime font-medium uppercase tracking-wider">Step {current + 1} of 4</span>
                </motion.div>
              ...
              {/* Progress indicators - brand colored */}
      ...
      {/* Fonts */}
      <link href="https://api.fontshare.com/v2/css?f[]=chillax@600,1&display=swap" rel="stylesheet" />
      <link href="https://api.fontshare.com/v2/css?f[]=technor@400,1&display=swap" rel="stylesheet" />
    </div>
  )
}